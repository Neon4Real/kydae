    ...
    return Promise.all(promises)
        .then(async results => {
            ...
            client.embed({
               ...
               {
                    name: "ℹ️┆Information",
                    value: `Kydae is a bot with which you can run your entire server! With no less than 550+ commands, we have a large bot with many options to improve your server!.coded by cmxn3on`,
                    inline: false,
                },
                {
                    name: "_____ \n\n│General",
