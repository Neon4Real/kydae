  ...
  client.on(Discord.Events.InteractionCreate, async (interaction) => {
    ...
    if (interaction.customId == "Bot-helppanel") {
      if (interaction.values == "commands-Bothelp") {
        ...
        client.embed({
          title: `❓・Help panel`,
          desc: `View all command categories in the bot here! \n\n[Website](kydae-web.averageneon.repl.co) | [Invite](${client.config.discord.botInvite}) | [Vote](https://top.gg/bot/1121643516158824508)`,
          ...
          collector.on('collect', async i => {
            if (i.customId == "helpNext") {
              if (page == 1) {
                client.embed({
                  title: `❓・Help panel`,
                  desc: `View all command categories in the bot here! \n\n[Website](http://kydae-web.averageneon.repl.co/) | [Invite](${client.config.discord.botInvite}) | [Vote](https://top.gg/bot/1121643516158824508)`,
