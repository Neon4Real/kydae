                        ...
                        client.embed({
                            ...
                            fields: [
                                ...
                                },
                                {
                                    ...
                                    value: `[Tech server](https://dsc.gg/cmxn3on) - Get help with code, tech and crypto while you read the latest news\n[Ban Appeal](https://discord.gg/htf9pHNRxA) - Got banned? Request an unban`,
                                },
                            ],
                            footer: {
                                text: `© TechPoint - 2022`,
                    ...
                    client.simpleEmbed({
                        ...
                        client.embed({
                            ...
                            fields: [
                                {
                                    name: `💻┇TechPoint`,
                                    value: `This is a server that mainly focused on everything that revolves around tech. For example, think of encryption, crypt or all new gadgets. Meet new people or learn more about tech yourself!. You can join this server by clicking [this](https://dsc.gg/cmxn3on) link`,
                                },
                                {
                                    name: `🤖┇Bot Support`,
                                    value: `This is the server you are currently on. All information about this server can be found in. You can get the link from this server to click on [this](https://dsc.gg/cmxn3on) link`,
                                },
                                {
                                    name: `🔨┇TechPoint Ban Appeal`,
                                    value: `This server is for the people who are banned from a server or from the bots. You can create a ticket here to request an unban and to participate in the servers again or to be able to use the bots again. You can join this server by clicking [this](https://dsc.gg/cmxn3on) link`,
                                },
                            ],
                            footer: {
                                text: `© TechPoint - 2022`,
